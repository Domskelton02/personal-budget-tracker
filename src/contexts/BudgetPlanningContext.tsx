...
export const BudgetPlanningProvider: React.FC<{
  ...
  const addCategory = useCallback(
    async (newCategoryData: NewBudgetCategory) => {
      setIsLoading(true);
      try {
        const addedCategory = await BudgetPlanningService.createCategory(
          newCategoryData
        );
  ...
  const updateCategory = useCallback(
    async (updatedCategory: BudgetCategory) => {
      setIsLoading(true);
      try {
